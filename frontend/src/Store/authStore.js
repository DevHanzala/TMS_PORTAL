...
export const useAuthStore = create((set) => ({
  ...
  login: async (stakeholder, credentials) => {
    ...
    try {
      ...
      // Store the full user object with all fields, including the latest ones
      const userData = {
        ...response.data.user,
        ...
        guardian_phone: response.data.user.guardian_phone,         // Added
        reference_name: response.data.user.reference_name,         // Added
        reference_contact: response.data.user.reference_contact,   // Added
        has_disease: response.data.user.has_disease,               // Added
        disease_description: response.data.user.disease_description // Added
      };
